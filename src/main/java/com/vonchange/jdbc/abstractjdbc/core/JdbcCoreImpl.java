...
public abstract class JdbcCoreImpl implements IJdbcCore{
    private static final Logger logger = LoggerFactory.getLogger(JdbcCoreImpl.class);
    protected  abstract YhJdbcTemplate initJdbcTemplate(String sql);
    @Override
    public Object insert(String sql, Object[] parameter) {
        logSql(sql, parameter);
        YhJdbcTemplate jdbcTemplate = initJdbcTemplate(sql);
