...
plainSelect.setOffset(offset);
      ...
      if (jj_2_28(2147483647) && (limit==null)) {
        limit = LimitWithOffset();
plainSelect.setLimit(limit);
      } else {
        ;
...
not=true; exclamationMarkNot=true;
      ...
      case 249:{
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case 237:{
          sign = jj_consume_token(237);
          break;
          }
        case 249:{
          sign = jj_consume_token(249);
          break;
          }
        case 241:{
          sign = jj_consume_token(241);
          break;
          }
        default:
          jj_la1[269] = jj_gen;
...
retval = new CollateExpression(retval, token.image);
      ...
      if (jj_2_98(2) && (dateExpressionAllowed)) {
...
fs.setAgainstValue(new StringValue(againstValue.image));
    ...
    case 273:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case 270:{
        searchModifier = jj_consume_token(270);
        break;
        }
      case 271:{
        searchModifier = jj_consume_token(271);
        break;
        }
      case 272:{
        searchModifier = jj_consume_token(272);
        break;
        }
      case 273:{
...
return result;
  ...
  private boolean jj_3R_611()
 {
  ...
  public CCJSqlParser(Provider stream) {
	 ...
	 jj_ntk = -1;
	 jj_gen = 0;
	 for (int i = 0; i < 435; i++) jj_la1[i] = -1;
