 ...
 * #L%
 */
package com.vonchange.jsqlparser.statement.replace;

import java.util.List;

import com.vonchange.jsqlparser.expression.Expression;
import com.vonchange.jsqlparser.expression.operators.relational.ItemsList;
...
public class Replace implements Statement {
    ...
    /**
     * A list of {@link com.vonchange.jsqlparser.expression.Expression}s (from a "REPLACE mytab SET
